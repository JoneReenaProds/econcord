      ...
      <div className="crm-sidebar" style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
        <div>
          <div className="crm-logo-box">
            <h2 className="crm-logo-text">Enova Concord</h2>
            <span style={{ fontSize: '10px', textTransform: 'uppercase', letterSpacing: '1px', fontWeight: 'bold', display: 'block', marginTop: '-4px', opacity: 0.7 }}>
              [{userRole}]
            </span>
          </div>
