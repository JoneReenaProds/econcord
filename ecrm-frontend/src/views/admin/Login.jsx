  ...
  <div className="crm-card-paper" style={{ width: '100%', maxWidth: '380px', padding: '32px', boxSizing: 'border-box', border: '2px solid #111111' }}>
    ...
    <div style={{ display: 'flex', justifyContent: 'center', marginBottom: '16px' }}>
      <pre style={{ 
        ...
        color: '#111111',
        fontWeight: 'bold',
        textAlign: 'left' // Mantiene la matriz de caracteres intacta
      }}>
{`  ###
 #   #
 #####
 #
  ###`}
    ...
    <h1 style={{ margin: '0 0 8px 0', fontSize: '24px', fontWeight: 'normal', textAlign: 'center' }}>Enova Concorde</h1>
